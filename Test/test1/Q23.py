# 23)Write a Python script that takes an integer between 1 and 7 as input and prints the corresponding day of the week (1 for Monday, 2 for Tuesday, etc.). If the number is outside this range, print "Invalid input".
...
if day == 1:
    ...
    print("Invalid number of the day")